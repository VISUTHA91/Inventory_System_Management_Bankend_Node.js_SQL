...
class Customer {
    ...
    static async update(id, data) {
        const { name, phone, email, address, purchased_item, purchased_quantity, amount, status } = data;
        await Customer.query(
            ...
            [name, phone, email, address, purchased_item, purchased_quantity, amount, status, id]
        );
    }
